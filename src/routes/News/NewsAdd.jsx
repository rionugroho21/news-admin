          ...
          <div className="card-body card-block">
            <form onSubmit={this.handleSubmit}>
              ...
              <div className="form-group">
                ...
                />
                <label className="checkbox-inline mgl10">
                  <input type="checkbox" id="nf-present" name="present" value={this.state.present} checked={this.state.checkPresent} onChange={this.handleCheck} /> Present
                </label>
              </div>
              <div className="form-group">
              ...
              <div className="form-group">
                ...
                <label className="checkbox-inline">
                  <input type="checkbox" id="nf-akses" name="akses" value="Private" defaultChecked={this.state.checked} onChange={this.handlechange} /> Private
                </label>
              </div>
              <div className="form-group">
