            ...
            <form onSubmit={this.handleSubmit}>
              ...
              <div className="form-group">
                ...
                <label className="checkbox-inline">
                  <input type="checkbox" id="nf-akses" name="akses" value="Private" checked={this.state.checked} onChange={this.handlechange} /> Private
                </label>
              </div>
              <div className="form-group">
                <label htmlFor="nf-writer" className="form-control-label">Writer</label>
                <label className="radio-inline">
                  <input type="radio" name="writer" checked={this.state.writer === 'Admin'} value="Admin" onChange={this.handlechange} /> Admin
                </label>
                <label className="radio-inline">
                  <input type="radio" name="writer" checked={this.state.writer === 'Guest'} value="Guest" onChange={this.handlechange} /> Guest
                </label>
              </div>
              <div className="form-group">
...
const mapDispatchToProps = (dispatch) => {
  return bindActionCreators({
    startEditingNews, startLoadingNews, startLoadingCat
  }, dispatch);
};
